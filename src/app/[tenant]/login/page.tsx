  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f5f2ec' }}>
      <div style={{ width: 360, background: 'white', borderRadius: 14, padding: 32, border: '1px solid rgba(15,15,15,0.1)' }}>
        ...
        <h1 style={{ fontFamily: 'Georgia, serif', fontSize: 26, marginBottom: 6 }}>Bayi Girişi</h1>
        <p style={{ fontSize: 13, color: '#888', marginBottom: 24 }}>Hesabınla giriş yap.</p>
        ...
        <p style={{ textAlign: 'center', fontSize: 13, color: '#888', marginTop: 20 }}>
          Hesabın yok mu?{' '}
          <Link href={`/${slug}/register`} style={{ color: '#0f0f0f', fontWeight: 500 }}>Kayıt ol</Link>
        </p>
      </div>
    </div>
  )
